...
namespace ChrisHaniHospital.Controllers
{
    public class CitiesController : Controller
    {
        ...
        public CitiesController(ChrisHaniContext context)
        {
            _context = context;
        }
        ...
        {
            var chrisHaniContext = _context.City.Include(c => c.Province);
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,ProvinceId")] City city)
        {
            ...
            ViewData["ProvinceId"] = new SelectList(_context.Province, "Id", "Id", city.ProvinceId);
            return View(city);
        }
