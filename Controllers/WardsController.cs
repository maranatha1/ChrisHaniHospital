...
namespace ChrisHaniHospital.Controllers
{
    public class WardsController : Controller
    {
        ...
        public WardsController(ChrisHaniContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,NumberOFBeds")] Ward ward)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,NumberOFBeds")] Ward ward)
        {
            if (id != ward.Id)
            {
                return NotFound();
