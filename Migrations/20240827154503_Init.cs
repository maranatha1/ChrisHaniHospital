    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Anaesthesiologists", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Surbub", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Surbub_City_CityId",
                        column: x => x.CityId,
                        principalTable: "City",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SurburbId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Patients_Surbub_SurburbId",
                        column: x => x.SurburbId,
                        principalTable: "Surbub",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllergiesNote = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdmittedPatients_Patients_PatinetId",
                        column: x => x.PatinetId,
                        principalTable: "Patients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdmittedPatients_Surbub_SuburbId",
                        column: x => x.SuburbId,
                        principalTable: "Surbub",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdmittedPatients_Surgeons_SurgeonID",
                        column: x => x.SurgeonID,
                        principalTable: "Surgeons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AdmittedPatients_Ward_WardId",
                        column: x => x.WardId,
                        principalTable: "Ward",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BodyTemparature = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AdmittedPatients_PatinetId",
                table: "AdmittedPatients",
                column: "PatinetId");

            migrationBuilder.CreateIndex(
                name: "IX_AdmittedPatients_SuburbId",
                table: "AdmittedPatients",
                column: "SuburbId");

            migrationBuilder.CreateIndex(
                name: "IX_AdmittedPatients_SurgeonID",
                table: "AdmittedPatients",
                column: "SurgeonID");

            migrationBuilder.CreateIndex(
                name: "IX_AdmittedPatients_WardId",
                table: "AdmittedPatients",
                column: "WardId");
